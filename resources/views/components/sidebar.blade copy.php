      ...
      <ul class="flex flex-col pl-0 mb-0">
        ...
        <li class="mt-0.5 w-full">
            <a
              ...
              onclick="toggleSubmenu('submenu1', 'arrowIcon1')">
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Kesiswaan</span>
              <i id="arrowIcon" class="ml-auto fas fa-chevron-down transition-transform duration-300"></i>
            </a>
            <!-- Submenu -->
            <ul id="submenu1" class="hidden flex-col pl-12">
              <li class="py-2">
                <a href="/siswa" class="text-sm text-gray-700 hover:text-blue-500">Data Siswa</a>
              </li>
              <li class="py-2">
                <a href="./pages/table2.html" class="text-sm text-gray-700 hover:text-blue-500">Siswa Keluar</a>
              </li>
            </ul>
        </li>
    {{-- kesiswaan 2 --}}
        <li class="mt-0.5 w-full">
            <a
              class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors cursor-pointer"
              onclick="toggleSubmenu('submenu2', 'arrowIcon1')"
            >
              <div class="shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  <title>office</title>
              ...
              <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Kesiswaan2</span>
              <i id="arrowIcon" class="ml-auto fas fa-chevron-down transition-transform duration-300"></i>
            </a>
            <!-- Submenu -->
            <ul id="submenu2" class="hidden flex-col pl-12">
              <li class="py-2">
                <a href="./pages/table1.html" class="text-sm text-gray-700 hover:text-blue-500">Data Siswa2</a>
              </li>
              <li class="py-2">
                <a href="./pages/table2.html" class="text-sm text-gray-700 hover:text-blue-500">Siswa Keluar2</a>
              </li>
            </ul>
        </li>
